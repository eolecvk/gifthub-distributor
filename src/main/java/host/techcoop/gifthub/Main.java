...
public class Main {
  public static void main(String[] args) {
    ...
    UpdateRequest request =
        gson.fromJson(
            "{\"events\":[{\"kind\": \"ADJUST\",\"bar_id\": 1234, \"new_value\": 0.5},{\"kind\": \"EMOTIVE\",\"emotion\":\"smiley face\",\"bar_id\": 1234 },{\"kind\":\"NEEDS_UPDATE\",\"needs_description\": \"i needs it\", \"needs_upper_bound_cents\": 1234,\"needs_lower_bound_cents\": 1234}]}",
            UpdateRequest.class);
