...
function ButtonUpdateDefaultDistribution(props) {
    return (
        <div>
            ...
            <button onClick={e => props.updateDefaultDistribution('survive')}>Survive amounts</button>
            <button onClick={e => props.updateDefaultDistribution('thrive')}>Thrive amounts</button>
        </div>
    )
}
