            ...
            <div className='button-group'>
                <ButtonGroup
                    ...
                    <Button
                        ...
                        onClick={this.handleOpenModalCreateRoom}>
                        New room
                    </Button>

                    <Modal
                        isOpen={this.state.createRoomModalIsOpen}
                        onCloseModal={this.handleCloseModalCreateRoom}>
                        ...
                        <div
                            ...
                            <span
                                class="close"
                                onClick={this.handleCloseModalCreateRoom}>
                                &times;
                            </span>

                            <p>
                                <CreateRoomForm
                                    onChange={this.handleCloseModalCreateRoom}
                                />
                            </p>
                        </div>
                    </Modal>
                    ...
                    <Button
                        name="joinRoomButton"
                        onClick={this.handleOpenModalJoinRoom}>
                        Join room
                    </Button>

                    <Modal
                        isOpen={this.state.joinRoomModalIsOpen}
                        onCloseModal={this.handleCloseModalJoinRoom}>
                        ...
                        <div
                            ...
                            <span
                                class="close"
                                onClick={this.handleCloseModalJoinRoom}>
                                &times;
                            </span>
                            <p>
                                <JoinRoomForm
                                    onChange={this.handleCloseModalJoinRoom}/>
                            </p>
                        </div>
                    </Modal>
                </ButtonGroup>
